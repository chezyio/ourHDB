      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 py-24 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div>
          ...
          <p className="mt-4 text-gray-500">
            OurHDB is a initiative created to help residents living in HDBs with
            common daily tasks and make it easier to solve frequent issues that
            many of the residents may face and give them a platform that is easy
            to use yet powerful.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="sm:text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600">
            OurCarpark allows residents to check available lots at any carpark
            across the island, making planning ahead much more convenient.
          </p>
        </div>
              ...
              <Link href={`/events/${event.id}`}>
                <div key={event.name} className="group relative">
                  ...
                  <div className="flex justify-between mt-4">
                    ...
                    <p className="text-sm font-heavy">{event.time}</p>
                  </div>
                </div>
              </Link>
            ))}
