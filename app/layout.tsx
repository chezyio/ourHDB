...
export default function RootLayout({
    ...
    return (
        <html>
            ...
            <div className="bg-lime-100">logo</div>
            <div>
              <Link
                href="/"
                className="text-slate-900 dark:text-slate-500 focus:text-white px-4 py-2  hover:bg-slate-200"
              >
                Home
              </Link>
                    ...
                    <div className="mx-auto max-w-7xl px-6 py-8 lg:px-8">
                        ...
                        <div className="flex justify-between items-center">
                            <p className="text-xs text-slate-900 dark:text-white">
                                &#169; {year} NTU SCSE · Built in Singapore
                            </p>
                        </div>
                    </div>
                </footer>
